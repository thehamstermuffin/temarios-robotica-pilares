...
desarrollo de competencias tecnológicas mediante la exploración de la electrónica
básica y la programación aplicada al control de dispositivos.
A lo largo del curso, las y los participantes aprenderán a construir circuitos,
interpretar señales eléctricas y programar microcontroladores para automatizar
tareas, transformando ideas en prototipos funcionales.
El taller promueve el aprendizaje activo, la experimentación y la resolución de
problemas reales, fortaleciendo el pensamiento lógico y la autonomía tecnológica.
Más allá del aspecto técnico, se fomenta el trabajo colaborativo y la apropiación de
...
No indispensables; se recomienda familiaridad básica con el
uso de computadoras.
...
Objetivo General
Al finalizar el curso, las y los participantes diseñarán y programarán sistemas
electrónicos básicos mediante el uso de la plataforma Arduino, integrando sensores
y actuadores para automatizar procesos, con el propósito de desarrollar habilidades
...
Duración
La duración del taller se establece en 24 horas como referencia para garantizar la
comprensión de los fundamentos electrónicos y permitir la construcción de un
prototipo funcional.
No obstante, el facilitador podrá ajustar la duración —por ejemplo, a 20 horas— si la
evaluación diagnóstica o el ritmo del grupo evidencian el logro de los objetivos de
aprendizaje.
Esta flexibilidad favorece la adaptación pedagógica sin comprometer la aplicación
...
IDE, estructura del código

Programarán su primer
dispositivo
...
Señales digitales y PWM

Automatizarán acciones
simples
...
Identifico componentes electrónicos

2

Construyo circuitos básicos

3

Interpreto diagramas simples

4

Programo una placa Arduino

5

Automatizo dispositivos

6

Integro sensores y actuadores

7

Detecto y corrijo fallas básicas
...
Aplico la electrónica a un problema real

10

Presento un prototipo funcional
...
las y los participantes en el diseño, construcción y programación de robots capaces
de desplazarse de manera autónoma o controlada.
A través de experiencias prácticas, explorarán los principios de locomoción, control
de motores, uso de sensores y lógica de navegación, transformando ideas en
prototipos funcionales que interactúan con su entorno.
El taller fomenta el pensamiento crítico, la experimentación tecnológica y el trabajo
colaborativo, promoviendo la robótica móvil como una herramienta para resolver
...
Se recomienda haber cursado un taller básico de electrónica,
Arduino o robótica introductoria, aunque no es estrictamente
obligatorio.
...
robot móvil capaz de desplazarse y responder a estímulos del entorno mediante la
integración de motores, sensores y sistemas de control, con el propósito de
desarrollar habilidades técnicas, pensamiento computacional y capacidades de
innovación aplicables en contextos comunitarios y tecnológicos.
...
Duración
La duración del taller se establece en 24 horas para favorecer el desarrollo
progresivo de competencias técnicas y permitir la construcción de un robot móvil
funcional.
No obstante, el facilitador podrá ajustar la duración —por ejemplo, a 20 horas— si la
evaluación diagnóstica evidencia que el grupo ha alcanzado los objetivos de
aprendizaje.
Esta flexibilidad permite adaptar el ritmo sin comprometer la comprensión ni la
aplicación práctica.
Recordemos que lo más importante es alcanzar el objetivo de aprendizaje.
...
Ultrasónico, infrarrojo

Detectarán obstáculos
...
Identifico los componentes de un robot móvil

2

Construyo una estructura estable

3

Configuro motores correctamente

4

Programo movimientos
...
Logro navegación básica

7

Resuelvo fallas técnicas

8

Optimizo el desempeño
...
desarrollo de competencias tecnológicas mediante la conexión de dispositivos
inteligentes capaces de recopilar datos, comunicarse entre sí y automatizar
procesos cotidianos.
Durante el curso, las y los participantes comprenderán los fundamentos del Internet
de las Cosas (IoT), explorarán tecnologías de conectividad y diseñarán sistemas
automatizados que respondan a necesidades reales de su entorno.
El taller prioriza el aprendizaje práctico, la experimentación tecnológica y el trabajo
colaborativo, promoviendo la apropiación de la tecnología como una herramienta
...
Se recomienda contar con nociones básicas de electrónica o
programación, aunque no es obligatorio.
...
básico de Internet de las Cosas capaz de monitorear variables del entorno y
automatizar acciones mediante la conexión de sensores, plataformas digitales y
dispositivos electrónicos, con el propósito de desarrollar habilidades tecnológicas y
fomentar soluciones innovadoras con impacto comunitario.
...
Duración
La duración del taller se establece en 24 horas como referencia para garantizar la
comprensión de los principios del IoT y permitir el desarrollo de un sistema
automatizado funcional.
No obstante, el facilitador podrá ajustar la duración —por ejemplo, a 20 horas— si la
evaluación diagnóstica o el avance del grupo evidencian el logro de los objetivos de
aprendizaje.
Esta flexibilidad favorece la adaptación pedagógica sin comprometer la aplicación
práctica.
Recordemos que lo más importante es alcanzar el objetivo de aprendizaje.
...
Comprendo qué es el IoT

2

Identifico los componentes del sistema

3

Configuro dispositivos conectados

4

Leo datos desde sensores

5

Transmito información a una plataforma

6

Visualizo datos en tiempo real

7

Configuro automatizaciones

8

Aplico medidas básicas de seguridad digital
...
Presento un sistema IoT funcional
...
environments. River Publishers.
 Richardson, M., & Wallace, S. (2012). Getting started with Raspberry Pi. O’Reilly
Media.
​
...
orientado al desarrollo de soluciones tecnológicas que permitan mejorar la
seguridad, el confort y la eficiencia energética en los hogares mediante sistemas
automatizados.
Durante el curso, las y los participantes explorarán los fundamentos de la
automatización doméstica, integrando sensores, actuadores y plataformas digitales
para diseñar prototipos funcionales capaces de responder a condiciones del
entorno.
El taller promueve el aprendizaje práctico y colaborativo, fomentando la innovación
tecnológica con sentido social. Se busca que las y los participantes reconozcan la
domótica como una herramienta accesible para fortalecer el bienestar comunitario y
...
Deseables nociones básicas de electrónica o programación,
...
Objetivo General
Al finalizar el curso, las y los participantes diseñarán e implementarán un sistema
básico de automatización doméstica mediante la integración de sensores,
actuadores y plataformas digitales, con el propósito de desarrollar habilidades
tecnológicas aplicables al hogar y promover soluciones innovadoras que favorezcan
...
comprensión de los fundamentos de la domótica y el desarrollo de un sistema
automatizado funcional.
No obstante, el facilitador podrá ajustar la duración —por ejemplo, a 20 horas— si la
evaluación diagnóstica evidencia que el grupo ha alcanzado los objetivos de
aprendizaje.
...
Configuro sensores correctamente

4

Programo automatizaciones

5

Controlo dispositivos eléctricos

6

Integro conectividad

7

Optimizo el funcionamiento del sistema

8

Aplico medidas básicas de seguridad tecnológica
...
Presento un sistema domótico funcional
...
 Aldrich, F. (2003). Smart homes: Past, present and future. Inside the Smart
Home, 17–39.
 Chan, M., Estève, D., Escriba, C., & Campo, E. (2008). A review of smart
homes—Present state and future challenges. Computer Methods and Programs in
...
orientado al desarrollo del pensamiento computacional y la creatividad tecnológica
mediante la construcción de proyectos interactivos que respondan a intereses y
necesidades del entorno.
Durante el curso, las y los participantes explorarán herramientas de programación
visual, sensores y dispositivos electrónicos para diseñar soluciones innovadoras que
integren arte, tecnología y funcionalidad.
El taller fomenta la experimentación, la expresión creativa y el trabajo colaborativo,
promoviendo la tecnología como un medio para la participación comunitaria y la
transformación social. Se busca que las y los participantes pasen de ser usuarios de
...
No indispensables; se recomienda disposición para el
...
tecnológico creativo mediante herramientas de programación e interfaces
interactivas, con el propósito de fortalecer el pensamiento computacional, la
expresión innovadora y la apropiación de la tecnología como herramienta para el
...
progresivo que permita a las y los participantes idear, diseñar y desarrollar un
proyecto tecnológico funcional.
No obstante, el facilitador podrá ajustar la duración —por ejemplo, a 20 horas— si la
evaluación diagnóstica evidencia que el grupo ha alcanzado los objetivos de
aprendizaje.
Esta flexibilidad permite adaptar el ritmo del curso sin comprometer la comprensión
...
Comprendo el pensamiento computacional

2

Utilizo herramientas de programación

3

Integro sensores en proyectos

4

Transformo ideas en prototipos

5

Aplico creatividad tecnológica

6

Resuelvo problemas durante el desarrollo

7

Mejoro mi proyecto con retroalimentación

8

Comunico el valor social de mi creación
...
Presento un proyecto funcional
...
orientado al desarrollo de habilidades tecnológicas avanzadas mediante el diseño,
construcción y programación de robots preparados para enfrentar retos de
competencia educativa.
Durante el curso, las y los participantes trabajarán bajo metodologías de aprendizaje
basado en retos, integrando conocimientos de mecánica, electrónica y
programación para optimizar el rendimiento de sus prototipos. Además, explorarán
la toma de decisiones estratégicas, el análisis de reglamentos y la mejora continua
como elementos clave del desempeño competitivo.
El taller fomenta la disciplina tecnológica, el pensamiento sistémico y el trabajo
colaborativo, promoviendo la robótica como un medio para potenciar el talento,
...
Se recomienda haber cursado talleres de electrónica, Arduino
o robótica móvil, o contar con experiencia básica en
construcción y programación de prototipos.
...
robot de competencia capaz de ejecutar tareas específicas dentro de un entorno
controlado, aplicando principios de ingeniería, programación y estrategia, con el
propósito de desarrollar habilidades técnicas avanzadas, pensamiento analítico y
...
Duración
La duración del taller se establece en 24 horas para permitir el desarrollo progresivo
de competencias técnicas y la construcción de un robot competitivo funcional.
No obstante, el facilitador podrá ajustar la duración —por ejemplo, a 20 horas— si la
evaluación diagnóstica evidencia que el grupo ha alcanzado los objetivos de
aprendizaje.
Esta flexibilidad favorece la adaptación pedagógica sin comprometer la aplicación
...
Peso, tracción, estructura

Diseñarán prototipos
eficientes
...
Comprendo la lógica de la robótica competitiva

2

Diseño estructuras eficientes

3

Integro sistemas electrónicos

4

Programo control preciso

5

Utilizo sensores estratégicamente

6

Optimizo el rendimiento del robot

7

Aplico procesos de prueba y mejora

8

Desarrollo estrategias de competencia

9

Trabajo eficazmente en equipo

10

Compito con un robot funcional
...
 Craig, J. J. (2018). Introduction to robotics: Mechanics and control (4th ed.).
Pearson.
